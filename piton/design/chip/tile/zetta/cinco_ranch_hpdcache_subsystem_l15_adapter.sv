...
//  }}}
  ...
  logic [AddrWidth-1:0]                icache_miss_resp_inval_address;
  ...
  assign icache_miss_resp_meta_rok = icache_miss_resp_w,
         ...
         icache_miss_resp_inval_address = icache_miss_resp_wdata.mem_inval[AddrWidth-1:0];
  //    }}}
  //  }}}
  ...
  assign dcache_read_ready_o                  = mem_req_ready[DcacheReadPort],
         mem_req_valid[DcacheReadPort]            = (dcache_read_i.mem_req_command == hpdcache_pkg::HPDCACHE_MEM_ATOMIC && dcache_read_i.mem_req_atomic == hpdcache_pkg::HPDCACHE_MEM_ATOMIC_LDEX) ? dcache_read_valid_i & sc_backoff_over :
                                                                                                                               dcache_read_valid_i,
  ...
  assign inval_ready = dcache_read_resp_ready_i, // Refill ready declares if hpdc is ready to receive an invalidation
         ...
         inval       = mem_resp.mem_inval[AddrWidth-1:$clog2(CacheLineWidth/8)]; // Convert address to cacheline number
